...
PAGES = [
    ...
    ("03-gesu-cristo","3 · Gesù Cristo","La soluzione: Gesù Cristo","c3"),
    ("04-come-vengo-salvato","4 · La salvezza","Come vengo salvato","c4"),
    ("05-cinque-sola","5 · Le 5 Sola","Le Cinque «Sola»","c5"),
    ("06-tulip","6 · TULIP","La grazia sovrana (TULIP)","c6"),
    ("07-false-dottrine","7 · False dottrine","Attenzione alle false dottrine","c7"),
    ("08-la-chiesa","8 · La chiesa","La vita nella chiesa","c8"),
    ("09-radici-storiche","9 · Storia","Le radici storiche","c9"),
    ("10-primi-passi","10 · Primi passi","I tuoi primi passi","c10"),
...
PERCHE = """
  <section class="sheet" id="perche-fidarsi">
    <div class="col">
      ...
      <p class="rv">Dove vedi un piccolo <strong>ⓘ</strong>, cliccalo: si apre la fonte esatta — un versetto, un manoscritto, uno studio, con il link per andare a controllare. Nessuna frase importante resta senza prova.</p>
